...
#else
							// Mark Tully : 27/12/11 : TNT Basic data comes from Codewarrior compiled apps, which assumed bool was 1 byte
							// for data compatability, we need bools to be 1 byte
							Assert_(sizeof(inBool) == 1);
